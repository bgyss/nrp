...
| H4 | Rig compositing on the WebGPU runtime | done (partial: parity passes clean, 5.3x per-light speedup over CPU; slider p95 170.6ms misses the <=100ms target) | `out/h4-rig/report.json`, `docs/performance.md#rig-compositing-on-the-webgpu-runtime-hardening-track-rung-h4` |
